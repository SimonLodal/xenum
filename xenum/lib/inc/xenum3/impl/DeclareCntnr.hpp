 ...
 */
#ifndef _XENUM3_IMPL_DECLARE_CNTNR_HPP
#define _XENUM3_IMPL_DECLARE_CNTNR_HPP
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_BEGIN(CTXT)							\
	_XENUM3_DECLARE_CNTNR_BEGIN_DO(CTXT, _XENUM3_CTXT_GET_DECL(CTXT))

/**
 * Callback worker for _XENUM3_DECLARE_CNTNR_BEGIN().
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_BEGIN_DO(CTXT, DECL)						\
	/* Enum-container class. */								\
	class _XENUM3_DECL_GET_CNTNRNAME(DECL) {						NWLN \
	public:											NWLN \
		/* The enum-value class. Not used here, but useful for XenumSet and others. */	\
IND1		typedef ::_XENUM3_NS::XenumValue<_XENUM3_DECL_GET_CNTNRNAME(DECL)> value_t;	NWLN \
		/* Number of values in this enum class. */					\
IND1		static constexpr const size_t size = 0 _XENUM3_CALL_VALS(_XENUM3_ADD_ONE, CTXT);	NWLN \
		/* Integer type used for enum values. */					\
IND1		typedef BOOST_PP_IF(								\
			BOOST_PP_IS_EMPTY(_XENUM3_DECL_GET_INTTYPE(DECL)),			\
			::_XENUM3_NS::SelectInt<size>::type,					\
			_XENUM3_DECL_GET_INTTYPE(DECL)						\
		) index_t;									NWLN \
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_ENUM_NATIVE(CTXT)							\
	public:											NWLN \
IND1		enum class Enum : index_t {							NWLN \
			_XENUM3_CALL_VALS(_XENUM3_DECLARE_CNTNR_ENUM_NATIVE_MEMBER, CTXT)	\
IND1		};										NWLN

/**
 * Callback worker for _XENUM3_DECLARE_CNTNR_ENUM().
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_ENUM_NATIVE_MEMBER(CTXT, VALUEIDENT, ...)				\
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_ENUM_COPY(CTXT)							\
	_XENUM3_CALL_VALS(_XENUM3_DECLARE_CNTNR_ENUM_COPY_MEMBER, CTXT)
/**
 * Callback worker for _XENUM3_DECLARE_CNTNR_ENUM_COPY().
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_ENUM_COPY_MEMBER(CTXT, VALUEIDENT, ...)				\
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_IDENTPOOL(CTXT)							\
	protected:										NWLN \
		/* Identifier stringpool type. */						\
IND1		typedef struct {								NWLN \
			_XENUM3_CALL_VALS(_XENUM3_DECLARE_CNTNR_IDENTPOOL_MEMBER, CTXT)		\
...
IND1		typedef ::_XENUM3_NS::SelectInt<sizeof(IdentifierPool)>::type IdentifierOffset;	NWLN \
...
/**
 * Callback worker for _XENUM3_DECLARE_CNTNR_IDENTPOOL().
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_IDENTPOOL_MEMBER(CTXT, VALUEIDENT, ...)				\
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_FUNCS(CTXT)							\
	_XENUM3_DECLARE_CNTNR_FUNCS_DO(CTXT, _XENUM3_CTXT_GET_DECL(CTXT))

/**
 * Callback worker for _XENUM3_DECLARE_CNTNR_FUNCS().
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_FUNCS_DO(CTXT, DECL)						\
	public:											NWLN \
...
IND1		constexpr _XENUM3_DECL_GET_CNTNRNAME(DECL)(void) noexcept {}			NWLN \
...
IND1		typedef ::_XENUM3_NS::XenumCntnrIterator<_XENUM3_DECL_GET_CNTNRNAME(DECL)> iterator; NWLN \
 ...
 * @hideinitializer
 */
#define _XENUM3_DECLARE_CNTNR_END								NWLN \
	};											NWLN


#endif // _XENUM3_IMPL_DECLARE_CNTNR_HPP
