...
#define _XENUM5_DEFC_SIZE(CTXT, DECL)								\
	constexpr const size_t _XENUM5_DECL_GET_SCOPE(DECL)_XENUM5_CNTNR_NAME(DECL)::_size;	_XENUM5_NWLN
...
#define _XENUM5_DEFC_ENUM_COPY_MEMBER(CTXT, IDENT, ...)						\
	_XENUM5_DEFC_ENUM_COPY_MEMBER_PREFIX(CTXT, _XENUM5_CTXT_GET_DECL(CTXT))IDENT;		_XENUM5_NWLN
...
#define _XENUM5_DEFC_ENUM_COPY_MEMBER_PREFIX(CTXT, DECL)					\
	constexpr const										\
	_XENUM5_DECL_GET_SCOPE(DECL)_XENUM5_DECL_GET_VALUENAME(DECL)				\
	_XENUM5_DECL_GET_SCOPE(DECL)_XENUM5_CNTNR_NAME(DECL)::
