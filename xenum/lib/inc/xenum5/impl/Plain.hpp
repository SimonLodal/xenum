 ...
 */
#define _XENUM5_PROP_DECLS_PLAIN(PDEF, DECL, CTXT, Z)						\
	BOOST_PP_CAT(BOOST_PP_CAT(_XENUM5_PLAIN_, _XENUM5_PDEF_GET_PLACEMENT_STR(PDEF)), _DECLS)	\
	(											\
...
#define _XENUM5_PROP_DECLV_PLAIN(PDEF, CTXT, Z)							\
	BOOST_PP_CAT(BOOST_PP_CAT(_XENUM5_PLAIN_, _XENUM5_PDEF_GET_PLACEMENT_STR(PDEF)), _DECLV)	\
	(											\
		_XENUM5_PDEF_GET_NAME(PDEF),							\
		_XENUM5_PDEF_GET_DEPTH(PDEF),							\
		PDEF,										\
 ...
 */
#define _XENUM5_PROP_DEFINE_PLAIN(PDEF, DECL, CTXT, Z)						\
	BOOST_PP_CAT(BOOST_PP_CAT(_XENUM5_PLAIN_, _XENUM5_PDEF_GET_PLACEMENT_STR(PDEF)), _DEFINE)	\
	(											\
		_XENUM5_PDEF_GET_NAME(PDEF),							\
		_XENUM5_PDEF_GET_DEPTH(PDEF),							\
		PDEF,										\
 ...
 * context.
 */
#define _XENUM5_PROP_CHECK_PLAIN(PROPNAME, PDEF, DECL, CTXT, Z)					\
	BOOST_PP_CAT(BOOST_PP_CAT(_XENUM5_PLAIN_, _XENUM5_PDEF_GET_PLACEMENT_STR(PDEF)), _CHECK)	\
	(											\
		PROPNAME,									\
		PDEF,										\
...
#define _XENUM5_PLAIN_ITER_NODES_ROOT(CTXT, IDENT, ...)						\
	...
	(											\
		...
		BOOST_PP_DEC(_XENUM5_PDEF_GET_DEPTH(_XENUM5_CTXT_GET_PDEF(CTXT))),		\
...
#define _XENUM5_PLAIN_ITER_NODES_NONROOT_FLT(ITERPOS, NODE, CTXT)				\
	BOOST_PP_AND(										\
		...
		BOOST_PP_NOT(BOOST_PP_IS_EMPTY(_XENUM5_TT_ITERPOS_GET_INDEXPATH(ITERPOS)))	\
	)
...
#define _XENUM5_PLAIN_DECLARE_VALUENAME(ITERPOS, NODE, CTXT)					\
	...
	_XENUM5_PROP_GEN_NODE_NAME(CTXT, _XENUM5_TT_ITERPOS_GET_INDEXPATH(ITERPOS));		_XENUM5_NWLN \
...
#define _XENUM5_PLAIN_DEFINE_NODE(ITERPOS, NODE, CTXT)						\
	{											\
		...
		BOOST_PP_CAT(									\
			...
			BOOST_PP_BOOL(_XENUM5_TT_ITERPOS_GET_CHILDCOUNT(ITERPOS))		\
		) (ITERPOS, CTXT)								\
	},											_XENUM5_NWLN \
