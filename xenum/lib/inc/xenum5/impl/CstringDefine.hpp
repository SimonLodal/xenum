...
#define _XENUM5_CSTRING_HDR_DEFINE(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
	_XENUM5_CSTRING_SRC_DEFINE(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
 ...
 */
#define _XENUM5_CSTRING_SRC_DEFINE(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
	_XENUM5_CSTRING_SRC_DEFL(PROPNAME, DEPTH, PDEF, LOCALSCOPE, CTXT, Z)			\
	_XENUM5_CSTRING_SRC_DEFS(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\

/**
 * Define the local data and functions.
 */
#define _XENUM5_CSTRING_SRC_DEFL(PROPNAME, DEPTH, PDEF, LOCALSCOPE, CTXT, Z)			\
	...
	namespace {										_XENUM5_NWLN \
		...
		namespace LOCALSCOPE {								_XENUM5_NWLN \
			_XENUM5_INDENT_INC							\
			_XENUM5_CSTRING_SRC_DEFL_VALUES(PROPNAME, PDEF, CTXT, Z)		\
 ...
 */
#define _XENUM5_CSTRING_SRC_DEFS(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
	_XENUM5_CSTRING_SRC_DEFS_FUNCS(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
 ...
 */
#define _XENUM5_CSTRING_SRC_DEFL_VALUES(PROPNAME, PDEF, CTXT, Z)				\
 ...
 */
#define _XENUM5_CSTRING_SRC_DEFS_FUNCS(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, CTXT, Z)	\
	/* INC() because Nodes also has indexnodes for the leaf string values */		\
	_XENUM5_PROP_SRC_DEFINE_GET_SIZE(BOOST_PP_INC(DEPTH), CTXT, Z)				\
	_XENUM5_CSTRING_SRC_DEFS_GET_VALUE(PROPNAME, DEPTH, PDEF, LOCALSCOPE ::, SCOPE, STORENAME, Z)	\
 ...
 */
#define _XENUM5_CSTRING_SRC_DEFS_GET_VALUE(PROPNAME, DEPTH, PDEF, LOCALSCOPE, SCOPE, STORENAME, Z)	\
 ...
 */
// FIXME: Implement hdr. Using src impl for now.
#define _XENUM5_CSTRING_HDR_CHECK(PROPNAME, PDEF, LOCALSCOPE, SCOPE, STORENAME, Z)		\
	_XENUM5_CSTRING_SRC_CHECK(PROPNAME, PDEF, LOCALSCOPE, SCOPE, STORENAME, Z)		\
 ...
 */
#define _XENUM5_CSTRING_SRC_CHECK(PROPNAME, PDEF, LOCALSCOPE, SCOPE, STORENAME, Z)		\
	static_assert(										\
