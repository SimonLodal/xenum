...
#define _XENUM4_PROP_DECLS_PLAIN(CTXT, DECL, PROPDEF, Z)					\
	_XENUM4_PLAIN_DECLS_DATA(CTXT, DECL, PROPDEF, _XENUM4_PROPDEF_GET_NAME(PROPDEF), _XENUM4_PROPDEF_GET_PFX(PROPDEF), Z)	\
	_XENUM4_PLAIN_DECLS_FUNCS(CTXT, PROPDEF, _XENUM4_PROPDEF_GET_NAME(PROPDEF), _XENUM4_PROPDEF_GET_PFX(PROPDEF), Z)	\
