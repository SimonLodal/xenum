 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_DEFINE(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)		\
	/* FIXME: Also define the _valuecount_ and _nodecount_ integers - ? */			\
	constexpr const										\
		SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _t)					\
		SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _values_)				\
		/* Explicit size not needed */							\
		/*[SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _valuecount_)] = */		\
		[] =										\
		{										NWLN \
	...
	) (CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_DATA_MULTILEVEL_0(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_DATA_MULTILEVEL_1(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)	\
	_XENUM4_PLAIN_VALUES_NAMES(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX)		\
	_XENUM4_PLAIN_NODES_NAMES(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)	\
	_XENUM4_PLAIN_NODES_DATA(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)		\
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_VALUES_NAMES(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX)		\
	typedef struct										\
	{ NWLN											\
	...
	static_assert(										\
		...
		sizeof(SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _values_)),			\
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_NODES_NAMES(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)	\
	typedef struct										\
	{ NWLN											\
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_NODES_DATA(CTXT, PROPDEF, SCOPE, STORENAME, PROPNAME, PROPPFX, Z)		\
	constexpr const										\
		SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _IndexNode_t)				\
		SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _nodes_)				\
		/* Explicit size not needed */							\
		/*[SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _nodecount_)] = */			\
		[] =										\
	{ NWLN											\
	...
	static_assert(										\
		...
		sizeof(SCOPE STORENAME :: BOOST_PP_CAT(PROPNAME, _nodes_)),			\
 ...
 * @hideinitializer
 */
#define _XENUM4_PLAIN_NODE_DATA_INDEX_1_DO(CTXT, PROPNAME, PROPPFX, INDEXPATH, NAMESTRUCT, MEMBERTYPE)	\
