 ...
 * Uses a test enum generated by xenum4-test-gen, included at the bottom.
 */
...
_TEST_ITERATE_DEPTH_INC_I2 beg: _XENUM4_TUPLETREE_STACK_DUMP(_XENUM4_TUPLETREE_STATE_GET_STACK(ITERSTATE)) _XENUM4_NWLN \
_TEST_ITERATE_DEPTH_INC_I2 inc: _XENUM4_TUPLETREE_STACK_DUMP(_XENUM4_TUPLETREE_DEPTH_INC(ITERSTATE)) _XENUM4_NWLN \

/*
_TEST_ITERATE_DEPTH_INC_I2 beg: _XENUM4_TUPLETREE_STACK_DUMP(_XENUM4_TUPLETREE_STATE_GET_STACK(ITERSTATE)) _XENUM4_NWLN \
_TEST_ITERATE_DEPTH_INC_I2 inc: _XENUM4_TUPLETREE_STACK_DUMP(_XENUM4_TUPLETREE_DEPTH_INC(ITERSTATE)) _XENUM4_NWLN \

_TEST_ITERATE_DEPTH_INC_I2 beg: _XENUM4_TUPLETREE_STATE_GET_STACK(ITERSTATE) _XENUM4_NWLN \
_TEST_ITERATE_DEPTH_INC_I2 inc: _XENUM4_TUPLETREE_DEPTH_INC(ITERSTATE) _XENUM4_NWLN \
*/
...
_TEST_ITERATE_DEPTH_GEN: ctxt=CTXT propvalue=PROPVALUE _XENUM4_NWLN \
...
/*
_TEST_FLT_CB: argc=BOOST_PP_VARIADIC_SIZE(__VA_ARGS__) _XENUM4_NWLN \
1
*/

#define _XENUM4_TEST_ITERATE_FLAT_GEN(CTXT, PROPVALUE)						\
_TEST_ITERATE_FLAT_GEN: ctxt=CTXT propvalue=PROPVALUE _XENUM4_NWLN \
...
_XENUM4_INDENT_ADD	[] ELEM _XENUM4_NWLN

#define _XENUM4_TUPLETREE_CALC_DUMP_STATE(STATE)						\
_TUPLETREE_CALC_DUMP_STATE:									\
	cdata:BOOST_PP_SEQ_SIZE(CDATA) : _XENUM4_NWLN							\
...
/*
_TEST_ITERATE_DEPTH_CALC: ctxt=CTXT propvalue=PROPVALUE _XENUM4_NWLN \
*/
...
/*
_TEST_RUN_VAL: ctxt=CTXT varargs=__VA_ARGS__ _XENUM4_NWLN \
*/
...
/*
_TEST_RUN_CALL_VALS_I1: ctxt=CTXT propdef=PROPDEF _XENUM4_NWLN \
*/
...
/*
_TEST_RUN_CALL_VALS: z=Z n=N ctxt=CTXT _XENUM4_NWLN \
*/
...
/*
_TEST_RUN_LOOP_PROPIDX: ctxt=CTXT _XENUM4_NWLN								\
*/
...
//_DO_DECLARE: ctxt=CTXT _XENUM4_NWLN

#define _XENUM4_DO_DEFINE(CTXT)									\
_XENUM4_TEST_RUN()

//_XENUM4_DECL_INIT(Dummies)
//_DO_DEFINE: ctxt=CTXT _XENUM4_NWLN
...
_GET_TUPLE_SIZE_IF_TUPLE [DATA1] = _XENUM4_GET_TUPLE_SIZE_IF_TUPLE(DATA1)	_XENUM4_NWLN \
_GET_TUPLE_SIZE_IF_TUPLE [DATA2] = _XENUM4_GET_TUPLE_SIZE_IF_TUPLE(DATA2)	_XENUM4_NWLN \
_GET_TUPLE_SIZE_IF_TUPLE [DATA3] = _XENUM4_GET_TUPLE_SIZE_IF_TUPLE(DATA3)	_XENUM4_NWLN \
_TUPLE_TO_SEQ_IF_TUPLE [DATA1] = _XENUM4_TUPLE_TO_SEQ_IF_TUPLE(DATA1)	_XENUM4_NWLN \
_TUPLE_TO_SEQ_IF_TUPLE [DATA2] = _XENUM4_TUPLE_TO_SEQ_IF_TUPLE(DATA2)	_XENUM4_NWLN \
_TUPLE_TO_SEQ_IF_TUPLE [DATA3] = _XENUM4_TUPLE_TO_SEQ_IF_TUPLE(DATA3)	_XENUM4_NWLN \
